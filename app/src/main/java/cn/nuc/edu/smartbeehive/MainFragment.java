...
import cn.nuc.edu.smartbeehive.bean.SensorBeehive;
import cn.nuc.edu.smartbeehive.utils.DBHelper;
...
//        initData();
    ...
    private void initView() {
        ...
        fxzhaungtai = (TextView) root.findViewById(R.id.fxzhaungtai);
        //menuLed = (LinearLayout) root.findViewById(R.id.menu_led);
        menuLed = root.findViewById(R.id.menu_led);
    ...
    private MqttCallback mqttCallback = new MqttCallbackExtended() {  //回传
        ...
        public void messageArrived(String topic, MqttMessage message) throws Exception {  // 接收的消息
            ...
            if (index == 7) {
                ...
                //sensorBeehive.setBid(String.valueOf(SimpleSensor.bbbid));
